...
import {faCheckCircle, faEdit, faSave, faSearch, faStar, faUser, faUsers} from "@fortawesome/free-solid-svg-icons";
...
const ParticipationCard = () => {
    ...
    return (
        <div className="w-full px-3 mx-auto">
            <div
                className="bg-white dark:bg-gray-800 flex flex-col rounded-lg items-center justify-center py-4 px-8 w-full">
                <div className="flex flex-row w-full p-3">
                    ...
                    <div className="ml-auto mr-5 relative">
                        ...
                        />
                        <span
                            className="pointer-events-none absolute inset-y-0 right-0 grid w-10 place-content-center text-gray-500 dark:text-gray-400">
