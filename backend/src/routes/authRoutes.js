...
router.put('/club/events/participantsCount', jwtMiddleware.verifyToken, eventController.setParticipantsCount);
...
router.put('/eventTeam/points/:teamId', jwtMiddleware.verifyToken, teamController.updateTeamPoints);
