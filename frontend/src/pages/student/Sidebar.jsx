...
const Sidebar = ({ onToggle }) => {
    ...
    return (
        <>
            ...
            <div className="z-100 fixed bottom-0 left-0 w-full bg-mirage-100 dark:bg-mirage-800 shadow-md md:hidden lg:hidden">
        ...
        return (
            ...
            >
                ...
                <div className="absolute bottom-4 ml-3">
                    ...
                    {/* Log Out Button */}
                    <div
                        className="flex items-center mt-4 p-2 hover:bg-mirage-300 dark:hover:bg-mirage-700 rounded cursor-pointer"
