                ...
                {clubs.length === 0 ? (
                    ...
                    clubs.map((club) => (
                        ...
                        >
                            ...
                            {/* Card Content */}
                            <div
                                className="relative flex flex-col justify-center items-center w-full h-full text-black dark:text-transparent group-hover:text-[#58c7fa] dark:group-hover:text-[#7bdfff] transition-all duration-500 font-cursive">
